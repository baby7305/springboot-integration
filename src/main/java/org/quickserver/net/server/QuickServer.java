...
public class QuickServer implements Runnable, Service, Cloneable, Serializable {
	 ...
	 *
	 * @throws org.quickserver.net.AppException if Server already running or if it could not load the classes
	 ...
	 *
	 * @throws org.quickserver.net.AppException if could not stop server
	 * @see #stopService
	 * @since 1.1
	 */
	 ...
	 *
	 * @throws org.quickserver.net.AppException if could not stop server or if it could not start the server.
	 * @since 1.2
	 */
	 ...
	 * @throws java.net.UnknownHostException if no IP address for
	 ...
	 *
	 * @param param of the xml configuration file.
	 * @throws AppException if QuickServerConfig creation failed from the xml config file.
	 * @since 1.4.7
	 */
	 ...
	 *
	 * @throws IllegalStateException if pool is not created yet.
	 * @since 1.3
	 */
	...
	protected void makeServerSocket()
		...
		} catch (Exception igrnore) {/*ignore*/} catch (Error igrnore) {/*ignore*/}
